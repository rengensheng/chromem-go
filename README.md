...
[![Go Reference](https://pkg.go.dev/badge/github.com/rengensheng/chromem-go.svg)](https://pkg.go.dev/github.com/rengensheng/chromem-go)
[![Build status](https://github.com/rengensheng/chromem-go/actions/workflows/go.yml/badge.svg)](https://github.com/rengensheng/chromem-go/actions/workflows/go.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/rengensheng/chromem-go)](https://goreportcard.com/report/github.com/rengensheng/chromem-go)
[![GitHub Releases](https://img.shields.io/github/release/rengensheng/chromem-go.svg)](https://github.com/rengensheng/chromem-go/releases)
...
import "github.com/rengensheng/chromem-go"
...
For the full interface see the Godoc: <https://pkg.go.dev/github.com/rengensheng/chromem-go>
...
- Embedding creators:
  ...
  - Bring your own (implement [`chromem.EmbeddingFunc`](https://pkg.go.dev/github.com/rengensheng/chromem-go#EmbeddingFunc))
...
- Performance:
  - Use SIMD for dot product calculation on supported CPUs (draft PR: [#48](https://github.com/rengensheng/chromem-go/pull/48))
...
`go get github.com/rengensheng/chromem-go@latest`

## Usage

See the Godoc for a reference: <https://pkg.go.dev/github.com/rengensheng/chromem-go>
...
PASS
ok   github.com/rengensheng/chromem-go 28.402s
```
